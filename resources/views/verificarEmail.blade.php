        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden h-full" style="max-width:1000px">
            <div class="md:flex w-full items-center justify-between ">
                <div class="hidden md:block w-1/2 ">
                    ...
                    <img class="m-auto mb-28" src="{{ asset('img/Email_recibido.png') }}" alt=""
                ...
                <div class="w-full md:w-1/2 py-16 px-8">
                    <div class="text-left mb-10 ">
                        <div class="relative pt-1 mx-14">
                            ...
                            <h1 class=" text-base text-center text-black mb-2 mt-3 font-dm-sans-medium">Paso 1 de 2</h1>
                        </div>
                        <h1 class="text-3xl text-center text-black mt-6 mb-2 sm:mt-20 font-dm-sans-bold">Verifica tu
                            correo electrónico</h1>
                        <p class="font-dm-sans-regular text-gray-600 text-base text-center mx-6">Hemos enviado un código
                            a tu correo electrónico para confirmar que te pertenece</p>
                    </div>
                    <div>
                        ...
                        <form action="{{ route('reenviarCodigo') }}" method="POST">
                            {{ csrf_field() }}
    ...
    @if (session('success') == 'Has verificado con éxito')
        <script>
            Swal.fire(
                ...
                if (result) {
                    window.location.href = "{{ route('verificarTelefono') }}"
                }
            })
        </script>
