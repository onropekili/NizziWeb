        ...
        <div class="bg-white text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1050px">
            <div class="md:flex w-full items-center justify-between ">
                <div class="hidden md:block w-1/2 ">
                    ...
                    <img class="m-auto mb-28" src="{{ asset('img/Email_recibido.png') }}" alt="" style="width: 320px; height: 320px;">
                </div>
                    ...
                    <div class="text-left mb-10 ">
                        <div class="relative pt-1 mx-10">
                            <div class="overflow-hidden h-2  mt-16 w-full text-xs flex rounded bg-gray-300">
                              <div style="width: 50%" class=" shadow-none flex flex-col text-center whitespace-nowrap bg-gradient-to-r from-customViolet via-customBlue1 to-customGreen"></div>
                            ...
                            <h1 class="font-bold text-xl text-center sm:text-texto text-black mb-2 mt-3 font-dm-sans-bold" >Paso 1 de 2</h1>

                          </div>
                        {{-- <img src="{{ asset('img/logoEdit.png') }}" alt="logo" class="h-8 max-h-8 mb-10"> --}}
                        <h1 class="font-bold text-3xl text-center sm:text-titulo text-black mt-6 mb-2 sm:mt-20 font-dm-sans-bold" >Verifica tu correo electrónico</h1>
                        <p class="font-dm-sans-medium text-gray-600 text-texto text-center" >Hemos enviado un código a tu correo electrónico para confirmar que te pertenece</p>
                    </div>
                    <div>
                        ...
                        <div class="flex text-left items-center mb-6">
                            <div class="flex">
                                <input type="text" class="w-1/4 border px-2 py-1 m-1 sm:m-3 bg-customGray rounded-lg text-center text-5xl" placeholder="">
                                <input type="text" class="w-1/4 border px-2 py-1 m-1 sm:m-3 bg-customGray rounded-lg text-center text-5xl" placeholder="">
                                <input type="text" class="w-1/4 border px-2 py-1 m-1 sm:m-3 bg-customGray rounded-lg text-center text-5xl" placeholder="">
                                <input type="text" class="w-1/4 border px-2 py-1 m-1 sm:m-3 bg-customGray rounded-lg text-center text-5xl" placeholder="">
                              </div>
                        ...
                        <p class=" font-dm-sans-medium text-gray-600 text-texto text-center mb-8"><a href="/verificarTel">Generar nuevo código en 02:59</a></p>
